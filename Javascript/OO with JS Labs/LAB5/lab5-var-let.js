...
var itemPrices = document.querySelector('#price-item')
var totalItem = document.querySelector('span.total-item')
...
for(var count=0; count<itemPrices.length; count++){
    if(parseInt(itemPrices[count].textContent)>=200){
        ...
        let finalPrice = 0.9 * parseInt(itemPrices[count].textContent)
